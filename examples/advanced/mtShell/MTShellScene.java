...
import advanced.plasmaPole.PlasmaPoleScene;
import advanced.plasmaPong.PlasmaPongScene;
import advanced.touchTail.TouchTailScene;
import basic.testScene.JoelsGame;
...
//		this.setClearColor(new MTColor(30,30,30,255));
		...
		if (this.useBackgroundGradient){
			Vertex[] vertices = new Vertex[]{
					...
					new Vertex(app.width, 	0,	0, 			0,0,0,255),
					new Vertex(app.width, app.height/2f,0,	170,170,140,255),
					new Vertex(0,	app.height/2f,	0,		170,170,140,255),
					new Vertex(0, 			0,		  0,	0,0,0,255),
			};
...
//		listHeight = app.width - 50;
		...
		font = FontManager.getInstance().createFont(app, "arial", 18, new MTColor(255,255,255), new MTColor(255,255,255));
//		font = FontManager.getInstance().createFont(app, "arial.ttf", 18, new MTColor(255,255,255), new MTColor(255,255,255));
		...
		this.addScene(new ICreateScene() {
			public Iscene getNewScene() {
				return new PlasmaPongScene(app, "Plasma Pong");
			}
			public String getTitle() {
				return "Plasma Pong";
			}
		}, app.loadImage(this.getPathToIcons() + "plasmapong_s.png"));

		this.addScene(new ICreateScene() {
			public Iscene getNewScene() {
				return new PlasmaPoleScene(app, "Plasma Sound");
			}
			public String getTitle() {
				return "Plasma Sound";
			}
		...
		this.addScene(new ICreateScene() {
			public Iscene getNewScene() {
				return new JoelsGame(app, "Particle Game");
			}
			public String getTitle() {
				return "Particle Game";
			}
		}, app.loadImage(this.getPathToIcons() + "particlegame_s.png"));
